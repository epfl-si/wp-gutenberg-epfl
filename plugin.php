...
function wp_gutenberg_epfl_editor_assets() {
    ...
    wp_localize_script(
        ...
        [
            ...
            'galerie' => plugins_url( 'src/block-thumbnails/galerie.jpg', __FILE__ ),
            'googleForm' => plugins_url( 'src/block-thumbnails/google-form.jpg', __FILE__ ),
            ...
            'studentProjets' => plugins_url( 'src/block-thumbnails/student-projets.jpg.jpg', __FILE__ ),
