...
function wp_gutenberg_epfl_editor_assets() {
	...
	wp_localize_script(
		...
		[
			...
			'sponsor'         => plugins_url( 'src/block-thumbnails/sponsor.jpg', __FILE__ ),
...
require_once plugin_dir_path( __FILE__ ) . 'shortcodes/epfl-allowed-datawrappers/epfl-allowed-datawrappers.php';
