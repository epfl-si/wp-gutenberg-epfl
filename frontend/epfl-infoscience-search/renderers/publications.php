...
function get_render_class_for_publication_2018($publication, $format) {
    ...
    if ($format === "detailed") {
        $record_renderer_class_base = '\EPFL\Plugins\Gutenberg\InfoscienceSearch\DetailedInfosciencePublication2018Render';
    } else {
        $record_renderer_class_base = '\EPFL\Plugins\Gutenberg\InfoscienceSearch\ShortInfosciencePublication2018Render';
    }
