<?php
    ...
    function epfl_people_render($persons, $from, $columns, $order) {
        ...
        $markup = $function_to_be_called($persons, $from, $order);
        return $markup;
    }

    function epfl_people_1($persons, $from, $order) {
        return epfl_people_card($persons, $from, '1', $order);
    }
    function epfl_people_3($persons, $from, $order) {
        return epfl_people_card($persons, $from, '3', $order);
    }
