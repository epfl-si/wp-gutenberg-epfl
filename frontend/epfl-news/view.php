<?php
    ...
    function epfl_news_render($results, $template, $all_news_link, $lang, $text_position, $gray_wrapper) {
        $function_to_be_called = __NAMESPACE__ . '\epfl_news_' . $template;
        $markup = $function_to_be_called($results, $all_news_link, $lang, $text_position, $gray_wrapper);
        return $markup;
    }
