...
namespace EPFL\Plugins\Shortcodes\EPFLFaq;
...
add_shortcode('epfl_faq', __NAMESPACE__ . '\epfl_faqbox_process_shortcode');
add_shortcode('epfl_faqItem', __NAMESPACE__ . '\epfl_faqboxitem_process_shortcode');
